    ...
    <body>
        <div class="container">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="active"><a href="#">Relationship Search</a></li>
            </ul>
           ...
           <form class="form-inline" method="GET" action="/relsearch">
               <div class="input-group">
                <input type="text" class="form-control" value="${relation!}" name="r" placeholder="Relationship">
            ...
            <div class="container">
                ...
                <ul class="pager">
                    <#if previous?has_content>
                        <li><a href="/relsearch?q=${query}&r=${relation}&_s=${previous}">Previous</a></li>
                    </#if>
                    <li><a href="/relsearch?q=${query}&r=${relation}&_s=${next}">Next</a></li>
                  </ul>
            </div>
        </#if>
    <body>
