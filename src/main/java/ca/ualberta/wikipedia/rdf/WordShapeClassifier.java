...
public class WordShapeClassifier {
	public static final int NOWORDSHAPE = -1;
	   ...
	   */
	  public int lookupShaper(String name) {
	    if (name == null) {
	      return NOWORDSHAPE;
	   ...
	   */
	  public boolean dontUseLC(int shape) {
	   ...
	   */
	  public String wordShape(String inStr, int wordShaper) {
	   ...
	   * @return The wordshape String
	   */
	  public String wordShape(String inStr, int wordShaper, Collection<String> knownLCWords) {
	   ...
	   */
	  public String wordShapeDan1(String s) {
	    boolean digit = true;
	    boolean upper = true;
	    boolean lower = true;
	    boolean mixed = true;
	   ...
	   */
	  public String wordShapeDan2(String s, Collection<String> knownLCWords) {
	  ...
	  public String wordShapeJenny1(String s, Collection<String> knownLCWords) {
	   ...
	   */
	  public String wordShapeChris2(String s, boolean omitIfInBoundary, Collection<String> knownLCWords) {
	    int len = s.length();
	  ...
	  public String wordShapeChris2Short(String s, int len, Collection<String> knownLCWords) {
	  ...
	  public String wordShapeChris2Long(String s, boolean omitIfInBoundary, int len, Collection<String> knownLCWords) {
	  ...
	  public char chris4equivalenceClass(final char c) {
	   ...
	   * @return A word shape for the word.
	   */
	  public String wordShapeChris4(String s, boolean omitIfInBoundary, Collection<String> knownLCWords) {
	    int len = s.length();
	    if (len <= BOUNDARY_SIZE * 2) {
	  ...
	  // Do the simple case of words <= BOUNDARY_SIZE * 2 (i.e., 4) with only 1 object allocation!
	  public String wordShapeChris4Short(String s, int len, Collection<String> knownLCWords) {
	    int sbLen = (knownLCWords != null) ? len + 1: len;  // markKnownLC makes String 1 longer
	    final StringBuilder sb = new StringBuilder(sbLen);
	    boolean nonLetters = false;
	  ...
	  public String wordShapeChris4Long(String s, boolean omitIfInBoundary, int len, Collection<String> knownLCWords) {
	   ...
	   */
	  public String wordShapeDan2Bio(String s, Collection<String> knownLCWords) {
...
/*	  public static void main(String[] args) {
		  System.out.println(wordShapeChris1("6"));
		  //System.out.println(wordShape("nouha Dziri 23",1));
		  ArrayList<String> list = new ArrayList<String>();
		  list.add("Canada");
		  list.add("2016.07.07");
		  System.out.println(wordShape("2015.07.04",8,list));
	    int i = 0;
